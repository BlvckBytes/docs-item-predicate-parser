...
const config: Config = {
  title: 'ItemPredicateParser Docs',
  tagline: 'Syntax- and API-Documentation',
  ...
  baseUrl: '/docs-item-predicate-parser/',
  ...
  themeConfig: {
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/BlvckBytes/ItemPredicateParser',
          label: 'GitHub',
          position: 'right',
        },
      ],
